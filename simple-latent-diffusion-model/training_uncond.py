...
if __name__ == '__main__':
    ...
    network = ConditionalUnetwork(10, 4, 3, 32, (1, 2, 4))
    model = ConditionalDiffusionModel(network, sampler, IMAGE_SHAPE).to(device)
    ...
    pt.show_images(a)
    loader = Loader2()
    #trainer.accelerated_train(dl, epochs = 10, file_name = 'diffusion_model/check_points/cond', no_label = False)
    loader.load('diffusion_model/check_points/cond_epoch6',model, ema = True, print_dict=True)
    a = model(1)
    print(a)
    pt.show_images(a)
